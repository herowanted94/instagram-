...
.controller('HomeCtrl', function($scope,Posts, PostsServer, $state, $cordovaCamera) {
...
.controller('SearchCtrl', function($scope) {
  ...
  $scope.loadImages = function() {
      for(var i = 0; i < 100; i++) {
          $scope.gallery.push({id: i, src: "img/wiz.png"});
      }
  }
})
...
.controller('AccountCtrl', function($scope) {
  ...
  $scope.loadImages = function() {
      for(var i = 0; i < 100; i++) {
          $scope.gallery.push({id: i, src: "img/wiz.jpg"});
      }
  }
});
